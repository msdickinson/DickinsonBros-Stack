...
using DickinsonBros.Infrastructure.SQL.Models;
...
namespace DickinsonBros.Infrastructure.SQL
{
    public class DataTableService : IDataTableService
    {
        ...
        public DataTableService(IMemoryCache memoryCache)
        {
        ...
        public DataTable ToDataTable<T>(IEnumerable<T> enumerable, string tableName)
        {
            ...
            var dataTable = (System.Data.DataTable)null;
        ...
        internal void FillDataTable<T>(System.Data.DataTable dataTable, PropertyInfo[] propertyInfos, IEnumerable<T> enumerable)
        {
