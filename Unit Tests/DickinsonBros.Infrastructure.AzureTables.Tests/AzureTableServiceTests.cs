...
namespace DickinsonBros.Infrastructure.AzureTables.Tests
{
    ...
    public class AzureTableServiceTests : BaseTest
    {
        ...
        [TestMethod]
        public async Task DeleteAsync_Runs_TelemetryServiceWriterInsertCalled()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
        ...
        [TestMethod]
        public async Task UpdateTelemetryRequest_HttpStatusCodeIs100_TelemetryResponseStateIsReciverError()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
        ...
        [TestMethod]
        public async Task UpdateTelemetryRequest_HttpStatusCodeIs200_TelemetryResponseStateIsSuccessful()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
                {
                    ...
                    //Assert
                    Assert.AreEqual(TelemetryResponseState.Successful, insertTelemetryRequest.TelemetryResponseState);
        ...
        [TestMethod]
        public async Task UpdateTelemetryRequest_HttpStatusCodeIs201_TelemetryResponseStateIsSuccessful()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
        ...
        [TestMethod]
        public async Task UpdateTelemetryRequest_HttpStatusCodeIs300_TelemetryResponseStateIsReciverError()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
        ...
        [TestMethod]
        public async Task UpdateTelemetryRequest_HttpStatusCodeIs400_TelemetryResponseStateIsCallerError()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
                {
                    ...
                    //Assert
                    Assert.AreEqual(TelemetryResponseState.CallerError, insertTelemetryRequest.TelemetryResponseState);
        ...
        [TestMethod]
        public async Task UpdateTelemetryRequest_HttpStatusCodeIs401_TelemetryResponseStateIsSuccessful()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
        ...
        [TestMethod]
        public async Task UpdateTelemetryRequest_HttpStatusCodeIs500_TelemetryResponseStateReciverError()
        {
            await RunDependencyInjectedTestAsync
            (
                async (serviceProvider) =>
        ...
        private (Mock<CloudTableClient>, Mock<CloudTable>) SetupCloudClientServices(IServiceProvider serviceProvider, Uri uri, string tableName, TableQuery<SampleEntity> tableQuery, TableQuerySegment<SampleEntity> tableQuerySegment, TableQuerySegment<SampleEntity> tableQuerySegmentWithNullToken)
        {
            ...
            CreateCloudClientFactoryMock(serviceProvider, cloudStorageAccountMock, cloudTableClientMock.Object);
            CreateCloudStorageAccountFactoryMock(serviceProvider, cloudStorageAccountMock);
